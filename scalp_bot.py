...
SYMBOLS = [
    ...
    "AVAX/USDT", "LINK/USDT", "ARB/USDT", "INJ/USDT", "DOT/USDT"
]
...
def send_signal(coin_name, direction, entry, tp1, tp2, tp3, sl,
    ...
    text = (
        ...
        f"  🟦  <b>TP2 (40%):</b>  <code>{tp2}</code>  <i>(+{TP2_PCT}%)</i>\n"
        f"  🟪  <b>TP3 (10%):</b>  <code>{tp3}</code>  <i>(+{TP3_PCT}%)</i>\n"
        f"\n"
        f"  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
        f"  🛑  <b>Stop Loss:</b>  <code>{sl}</code>  <i>(-{SL_PCT}%)</i>\n"
        f"\n"
        f"  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
        f"  📊  <b>Indicators:</b>\n"
